...
public class DutyStationController {
    ...
    public ResponseEntity<?> addDutyStation(
        ...
        DutyStationResponse response = dutyStationService.addDutyStation(tenantId, request);
    ...
    public ResponseEntity<?> getAllDutyStations(
        ...
        List<DutyStationResponse> responses = dutyStationService.getAllDutyStations(tenantId);
    ...
    public ResponseEntity<?> getDutyStationById(
        ...
        DutyStationResponse response = dutyStationService.getDutyStationById(tenantId, stationId);
    ...
    public ResponseEntity<?> deleteDutyStation(
        ...
        return ResponseEntity.status(HttpStatus.OK).body("Duty station deleted successfully!");
    }
}
