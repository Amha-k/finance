...
public class TrainingController {
    ...
    public ResponseEntity<?> getAllTrainings(
        ...
        List<TrainingResponse> trainings = trainingService.getAllTrainings(tenantId, employeeId);
    ...
    public ResponseEntity<?> getEmployeeTrainings(
        ...
        List<TrainingResponse> trainings = trainingService.getEmployeeTrainings(tenantId, employeeId);
        return ResponseEntity.ok(trainings);
    }
    ...
    public ResponseEntity<?> getTrainingById(
        ...
        TrainingResponse training = trainingService.getTrainingById(tenantId, employeeId, trainingId);
    ...
    public ResponseEntity<?> getTrainingCertificateById(
        ...
        if (training.getFileType() == null || training.getFileType().isEmpty()) {
            return ResponseEntity.noContent().build();
        }
        MediaType mediaType = MediaType.valueOf(training.getFileType());
        byte[] documentBytes = trainingService
                .getTrainingCertificateById(tenantId, employeeId, trainingId);
    ...
    public ResponseEntity<?> updateTraining(
        ...
        TrainingResponse training =
                trainingService.updateTraining(tenantId, employeeId, trainingId, trainingRequest, file);
        return ResponseEntity.ok(training);
    }
