...
public class EducationController {
    ...
    public ResponseEntity<?> getAllEducations(
        ...
        List<EducationResponse> educations = educationService.getAllEducations(tenantId, employeeId);
    ...
    public ResponseEntity<?> getAllEducationsByEmployeeId(
        ...
        List<EducationResponse> educations = educationService.getEmployeeEducations(tenantId, employeeId);
        return ResponseEntity.ok(educations);
    }
    ...
    public ResponseEntity<?> getEducationById(
        ...
        EducationResponse education = educationService.getEducationById(tenantId, employeeId, educationId);
    ...
    public ResponseEntity<?> getEducationDocumentById(
        ...
        EducationResponse education = educationService.getEducationById(tenantId, employeeId, educationId);
        if (education.getFileType() == null || education.getFileType().isEmpty()) {
            return ResponseEntity.noContent().build();
        }
        MediaType mediaType = MediaType.valueOf(education.getFileType());
        byte[] documentBytes = educationService.getEducationDocumentById(tenantId, employeeId, educationId);
    ...
    public ResponseEntity<?> updateEducation(
        ...
        EducationResponse education =
                educationService.updateEducation(tenantId, employeeId, educationId, educationRequest, file);
        return ResponseEntity.ok(education);
    }
