...
public class CountryController {
    ...
    public ResponseEntity<?> addCountry(
        ...
        CountryResponse response = countryService.addCountry(tenantId, request);
    ...
    public ResponseEntity<?> getAllCountries(
        ...
        List<CountryResponse> responses = countryService.getAllCountries(tenantId);
    ...
    public ResponseEntity<?> getCountryById(
        ...
        CountryResponse response = countryService.getCountryById(tenantId, countryId);
    ...
    public ResponseEntity<?> updateCountry(
        ...
        CountryResponse response = countryService.updateCountry(tenantId, countryId, request);
        return ResponseEntity.status(HttpStatus.OK).body(response);
    }
