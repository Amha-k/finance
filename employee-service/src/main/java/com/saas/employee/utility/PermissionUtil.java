...
public class PermissionUtil {
    ...
    public boolean isEmployeeHimself(UUID tenantId, UUID id, String employeeId) {
        ...
        if (employeeId != null) {
            return loggedInUsername.equals(employeeId);
        } else {
            Employee employee = validationUtil.getEmployeeById(tenantId, id);
            return loggedInUsername.equals(employee.getEmployeeId());
        }
    }
