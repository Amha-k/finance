...
public class ReferenceService {
    ...
    public ReferenceResponse addReference(UUID tenantId,
        ...
        Reference reference = referenceMapper.mapToEntity(tenantId, employee, request);
    ...
    public ReferenceResponse getReferenceById(UUID tenantId,
        ...
        Employee employee = validationUtil.getEmployeeById(tenantId, employeeId);
        Reference reference = getReferenceById(tenantId, employee, referenceId);
        return referenceMapper.mapToDto(reference);
    }
    ...
    public ReferenceResponse updateReference(UUID tenantId,
        ...
        Employee employee = validationUtil.getEmployeeById(tenantId, employeeId);
        Reference reference = getReferenceById(tenantId, employee, referenceId);
        reference = referenceMapper.mapUpdateRequest(reference, request);
        reference = referenceRepository.save(reference);
        return referenceMapper.mapToDto(reference);
    }
